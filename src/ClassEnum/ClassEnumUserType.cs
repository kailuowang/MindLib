...
namespace MindHarbor.ClassEnum {
	...
	public class ClassEnumUserType<EnumT> : IUserType {
		...
		/// </summary>
		public static readonly IType CustomeType = new CustomType(typeof (ClassEnumUserType<EnumT>), new Dictionary<string,string>());
		...
		public object NullSafeGet(IDataReader rs, string[] names, object owner) {
			...
			if (String.IsNullOrEmpty(name))
				return null;
			return ClassEnumBase.Parse(typeof (EnumT), name);
		}
		...
		public void NullSafeSet(IDbCommand cmd, object value, int index) {
			if (value == null)
				...
				NHibernateUtil.String.NullSafeSet(cmd, ((IClassEnum) value).Name, index);
		}
