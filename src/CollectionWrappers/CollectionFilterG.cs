...
namespace MindHarbor.CollectionWrappers {
	public class CollectionFilterG<T, OriginalT> : EnumerableFilter<T>, ICollection<T> {
		private ICollection<OriginalT> innerCollection;

		public CollectionFilterG(ICollection<OriginalT> toWrap) : base(toWrap) {
